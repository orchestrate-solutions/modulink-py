...
from .types import Ctx, Link, ChainFunction, MiddlewareFunction, Status
...
class ChainMiddleware:
    ...
    def before(self, mw: Union[MiddlewareFunction, List[MiddlewareFunction]]) -> 'ChainMiddleware':
    ...
    def after(self, mw: Union[MiddlewareFunction, List[MiddlewareFunction]]) -> 'ChainMiddleware':
