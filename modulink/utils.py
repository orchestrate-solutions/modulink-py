...
class Chain:
    ...
    async def __call__(self, ctx: Ctx) -> Ctx:
        ...
        # Execute each link with middleware pattern: [on_input] : link : [global] : [on_output]
        for link in self.links:
            # Apply onInput middleware for this link
            ...
            try:
                ...
                # Continue processing even with errors - let each link decide how to handle them
            except Exception as e:
                result["error"] = e
                # Continue to next link to allow error processing

            # Apply global middleware for this link
            ...
            # Apply onOutput middleware for this link
