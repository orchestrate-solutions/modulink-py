...
import pytest
import asyncio
from modulink import chain, Ctx
...
async def test_mixed_async_sync_middleware():
    ...
    expected_order = ["async_before", "sync_before", "link", "async_after", "sync_after"]
...
async def test_middleware_chaining():
    ...
    expected = [
        "before1", "before2", "link1", "after1", "after2",
        "before1", "before2", "link2", "after1", "after2"
    ]
