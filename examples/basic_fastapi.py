...
# Create FastAPI app
app = FastAPI(title="ModuLink Universal Types FastAPI Example")
...
# Create processing chains using universal types
...
if __name__ == "__main__":
    print("🚀 Starting ModuLink Universal Types FastAPI Demo")
